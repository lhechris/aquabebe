<!-- Pied de page -->
    <div id="footer">
		...
		<a class="mail" href="mailto:postmaster@aquabebe.fr">Pour signaler toute anomalie sur le site, contactez Marie-Aude...</a>
		<p class="legal">
		...
		utilise de manière privilégiée (<img src="<?=REPOSITORY?>/images/contact-feet.jpg" alt="adresse à recopier" /> ).
